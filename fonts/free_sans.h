...
const uint8_t FreeSans_Bitmaps[] PROGMEM = {
...
const GFXglyph FreeSans_Glyphs[] PROGMEM = {
  {     0,   0,   0,   5,    0,    1 },   // 0x20 ' '
  {     0,   2,  13,   6,    2,  -12 },   // 0x21 '!'
  {     4,   5,   4,   6,    1,  -12 },   // 0x22 '"'
...
const GFXfont FreeSans PROGMEM = {
  (uint8_t  *)FreeSans_Bitmaps,
  (GFXglyph *)FreeSans_Glyphs,
  0x20, 0x7E, 22 };
